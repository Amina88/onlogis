...
$id=$_GET['element_id'];
$delete_Fct=mysql_query("delete from element_purchase where reference='$reference' AND id='$id' ");
...
if($dtd[0]>$dtf[0]){
$tst=0;
$link="MenuUtilisation.php?valeur=ModifCommande.php& reference=$idf&titre=$N31:$idf&etat_up=0&msg=$N30&url=$url2.$N31";
}elseif($dtd[0]==$dtf[0]){
if($dtd[1]>$dtf[1]){
$tst=0;
$link="MenuUtilisation.php?valeur=ModifCommande.php& reference=$idf&titre=$N31:$idf&etat_up=0&msg=$N30&url=$url2.$N31";
...
if($dtd[0]<$PD[0]){
$tst=0;
$link="MenuUtilisation.php?valeur=ModifCommande.php& reference=$idf&titre=$N31:$idf&etat_up=0&msg=$N32&url=$url2.$N31";
}elseif($dtd[0]==$PD[0]){
if($dtd[1]<$PD[1]){
$tst=0;

$link="MenuUtilisation.php?valeur=ModifCommande.php& reference=$idf&titre=$N31&etat_up=0&msg=$N32&url=$url2.$N31";
...
if($dtd[0]>$PF[0]){
$tst=0;
$link="MenuUtilisation.php?valeur=ModifCommande.php& reference=$idf&titre=$N31:$idf&etat_up=0&msg=$N33&url=$url2.$N31";
}elseif($dtd[0]==$PF[0]){
if($dtd[1]>$PF[1]){
$tst=0;
...
if($tst==1){
$etat_up = mysql_query("update purchase set fournisseur ='$Four', dossiers='$doss',description ='$Resum', date_commande = '$D', date_echeance='$DP', type_de_monnaie = '$autre_monnaie'  ,Taux_monnaie_def='$DFT',operation='$OP',Reference_four='$Refer'  where reference = '$idf'");
$nbelemnt=mysql_query("select * from element_purchase where Reference='$idf'");
$nbel=0;
...
$TVAA=explode('/',$TVA);
$test = mysql_query("select quantite,prix_unitaire,monnaie, devise , tva from element_purchase where reference = '$idf' AND id='$id' ");
$req2=mysql_fetch_array($test);
if(($req2[0]!= "$qt") || ($req2[1] != "$prix") || ($req2[2] != "$monnaie") ||( $req2[3] != "$devis") || ($req2[4] != "$TVAA[1]") ){
$req = mysql_query("update purchase set confirmation=0 where  reference = '$idf'");
}
$etat_up=mysql_query("update element_purchase set designation='$desc',quantite=$qt,prix_unitaire='$prix',tva='$TVAA[1]',monnaie='$monnaie',devise='$devis',code_comptable='$compte', Type_tax='$TVAA[0]' where Reference='$idf' AND id='$id'");
...
$compte=$_POST["Compte".$i];
$TVAA=explode('/',$TVA);
$etat_up=mysql_query("insert into element_purchase values ($i,'$idf','$desc',$qt,'$prix','$monnaie',$devis,'$TVAA[1]','$compte','$TVAA[0]',0)")or die(mysql_error());
...
$confirm=mysql_query("select confirmation from purchase where reference='$idf'");
 $rese=mysql_fetch_array($confirm);
if($rese[0]=='1'){
$link="MenuUtilisation.php?valeur=AllCommande.php&titre=$tt&etat_up=$etat_up&url=$url&msg=$succes";
}else{
$link="MenuUtilisation.php?valeur=AllCommandeNonConfirmer.php&titre=$tt3&etat_up=$etat_up&url=$url3&msg=$succes";
}}
?>
<script type="text/javascript"> 
...
$facture=mysql_query("select * from purchase where reference='$reference'");
$element=mysql_query("select * from element_purchase where Reference='$reference'"); 
...
?>
<form method="POST" action="MenuUtilisation.php?valeur=ModifCommande.php" id="form_sample_2" class="form-horizontal" >
...
<?php }else{ ?>
<option value="<?php echo $res[13];?>" selected><?php echo $res[13];?>
...
<div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
												...
												<input type="text" class="form-control"  name="Date"  required  style="width:120px" value="<?php echo $res[4];?>" >
...
<div class="col-md-4">
<div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control"  name="Datep"  style="width:120px" required value="<?php echo $res[5];?>" >
												<span class="input-group-btn">
												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div>
...
<br><br>
<div class="col-md-4">
<input type="text"    class="form-control "   style="width:140px;" name="Ref" value="<?php echo $res[15];?>"  >
</div></div>
</td>
</tr>
<tr>
...
<br><br>
<div class="col-md-4">
<select name="Fournisseur"   required="required" class="form-control select2me"  style="width:150px" >
<option value=""></option>
...
<br><br>
<div class="col-md-4">
<input type="text" id="deviseVerLo"   class="form-control "   style="width:140px;" name="DFT"  value="<?php echo $res[9]; ?>" required="required" >
</div></div>
</td>
<td >
...
<option value="<?php echo $res[2];?>" selected><?php echo $res[2];?></option>
...
<div class="form-group">	
<div class="col-md-3">
<input type="number" min="0" value="<?php echo $elem[3];?>" id="qt<?php echo $nb; ?>" style="width:80px;" name="qt<?php echo $nb; ?>" required="required" class="form-control">
</div>
</div>
</td>
<td ><div class="form-group">	
<div class="col-md-3">
<input type="Number"  id="prix<?php echo $nb; ?>" style="width:80px;" name="prix<?php echo $nb; ?>"  value="<?php echo $elem[4];?>" onMouseOut="valider();" placeholder="0.00" required="required" class="form-control" >
</div></td>
</div></td>
<td>
<div class="form-group">	
...
<option value="" selected><?php echo $N17; ?></option>
<?php 
...
<?php
if($nb>1){  ?>
<td ><a href="MenuUtilisation.php?valeur=ModifCommande.php&reference=<?php echo $_GET['reference']; ?>&titre=<?php echo $_GET['titre']; ?>&url=<?php echo $_GET['url']; ?>&element_id=<?php echo $elem[0]; ?>&delete_Element=true"  title="suprimer" onclick="return confirmLink(this) ;" ><i class="fa fa-times"  ></i></a></td>
<?php }else{ ?>
<td >
</td >
<?php  } ?>
...
<a href="#" id="addNew"><?php echo $N18; ?><img src="images/add.png" ></a>
				...
				<table align="center">
	<tr><td><font size="1"><?php echo $N19; ?></h4></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><div id="NET"><font size="1"><?php echo number_format($TT, 2); ?></div></td><td><div id="mn"><?php echo"&nbsp;&nbsp;<font size=1>". $res[7];?></div></td></tr>
	<tr><td><font size="1"><?php echo $N20; ?></h4></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><div id="T"><font size="1"><?php echo number_format($TVA, 2); ?></div></td><td><div id="mn1"><?php echo"&nbsp;&nbsp;<font size=1>". $res[7];?></div></td></tr>
	<tr><td><font size="1"><?php echo $N21; ?></h4></td><td>&nbsp;&nbsp;&nbsp;&nbsp;</td><td><div id="TOTAL"><font size="1"><?php echo number_format($TS, 2); ?></div></td><td><div id="mn2"><?php echo"&nbsp;&nbsp;<font size=1>". $res[7];?></div></td></tr>
	...
	<div class="form-actions">
									 ...
									 <div class="row">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn green"  value="1" name="ModifierCommande" ><?php echo $N35; ?></button>
