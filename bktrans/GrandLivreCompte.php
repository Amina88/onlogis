...
function addEcheance( $date )
{
	...
	$this->SetFont( "times", "B", 10);
	$this->Cell(10,4,utf8_decode("Date de tirage"), 0, 0, "C");
	$this->SetXY( $r1 + ($r2-$r1)/2 - 5 , $y1 + 5 );
	$this->SetFont( "times", "", 10);
	$this->Cell(10,5,$date, 0,0, "C");
}
...
function FancyTableResum($header, $data)
{
	...
	if($row[0]!='Fin' &&$row[0]!='Start'){
        ...
        $this->Cell(280,8,$row[1].'               '.$row[2],'L',0,'L',$fill);
...
$this->SetFont('Arial','',8);
		...
		$fill = !$fill;
		 $this->SetFillColor(184);
		 $this->SetFont('Arial','',9);
        $this->Cell(125,8,$row[4],'R',0,'R',$fill);
        $this->Cell(65,8,$row[5],'R',0,'R',$fill);
        $this->Cell(45,8,$row[6],'R',0,'R',$fill);
        $this->Cell(44,8,$row[7],'R',0,'R',$fill);
...
$this->SetFont('Arial','',8);
  ...
  $this->SetFillColor(122);
  $this->Cell(284,8,"VIDE !!!!",'C',0,'C',$fill);
