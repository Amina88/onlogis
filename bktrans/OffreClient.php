...
require'includes/recOffreClient.php';
if($etat){
?>
...
$cl=$_GET['client'];
$s=mysql_query("select * from offre where client='$cl' ");
...
$tot=$tot;
  $client = str_replace('&','%26',$admin[2]);
		...
		<tr> 
    				...
    				<td>
					<?php if($admin[7]==1){?><span class="label label-sm label-success"><?php echo $N14; ?></span><?php }else{ ?>
					<span class="label label-sm label-danger"><?php echo $N15; ?></span> <?php } ?></td>
					...
					<a href="MenuUtilisation.php?valeur=ModifierOffre.php&id_Facture=<?php echo $admin[1];?>&titre=<?php echo $N18." ".$admin[1]; ?>&url=<?php echo $url2.$N18;?>" >
