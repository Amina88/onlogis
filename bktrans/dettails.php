...
$facture=mysql_query("select * from invoice where id_facture='$ref' ");
...
$datep=$fct[6];
$clireq=mysql_query("select * from custemer where Nom_Soc='$fct[5]'");
$cli=mysql_fetch_array($clireq);
$element=mysql_query("select * from element_invoice where Reference='$fct[3]'");
												...
												<div class="portlet blue-hoki box">
													...
													<div class="portlet-body">
														<div class="row static-info">
															...
															<a href="MenuUtilisation.php?valeur=ModifierClient.php&NomSOC=<?php echo $cli[0];?>&titre=<?php echo $N23." :  ".$cli[0]; ?>&url=<?php echo $urlC.".".$N23; ?>" target="_link"><?php echo $cli[0]; ?></a>
															</div>
														</div>
														<div class="row static-info">
															<div class="col-md-5 name">
												...
												<div class="portlet yellow-crusta box">
													...
													<div class="portlet-body">
														...
														<div class="row static-info">
															...
															<div class="col-md-7 value">
																<?php echo number_format($fct[18],2,',','.')."&nbsp;".$fct[9];?>
															</div>
														</div>
														<div class="row static-info">
															<div class="col-md-5 name">
								...
								<div class="col-md-6 ">
												<div class="well" >
													<div class="row static-info" >
														...
														<div class="col-md-7 value">
															 <?php  echo number_format($nett,2,',','.')." ".$fct[9] ; ?>
														</div>
													</div>
													<div class="row static-info ">
														<div class="col-md-3 name">
														...
														<div class="col-md-7 value">
															<?php  echo number_format($TVAA,2,',','.')." ". $fct[9] ; ?>
														</div>
													</div>
													<div class="row static-info ">
														<div class="col-md-3 name">
														...
														<div class="col-md-7 value">
															 <?php  echo number_format($TOTALL,2,',','.')." ".$fct[9]; ?>
														</div>
													</div>
...
$Mon=mysql_fetch_array($mn);
						...
						if($fct[12]!=$Mon[0]){ ?>
 <font size="2"><?php  echo   "1&nbsp;".$Mon[0]."=".$fct[13]."&nbsp;".$fct[12] ; ?><br><br>						
										<div class="row">
											<div class="col-md-6">
											</div>
								<div class="col-md-6 ">
												<div class="well" >
													<div class="row static-info ">
														...
														<div class="col-md-7 value">
															 <?php  echo number_format($nett*$fct[13],2,',','.')." ".$Mon[0] ; ?>
														</div>
													</div>
													<div class="row static-info">
														<div class="col-md-3 name">
														...
														<div class="col-md-7 value">
															<?php  echo number_format($TVAA*$fct[13],2,',','.')." ". $Mon[0] ; ?>
														</div>
													</div>
													<div class="row static-info">
														<div class="col-md-3 name">
														...
														<div class="col-md-7 value">
															 <?php  echo number_format($TOTALL*$fct[13],2,',','.')." ".$Mon[0]; ?>
														</div>
													</div>
