...
$ic="select REFERENCE as code,date_commande as date_lancement,date_echeance as date_paiement,type_de_monnaie as monnaie,DATE(date_commande) -  DATE(date_echeance)  as echue,valeur_payer as valeur_payer  from purchase where fournisseur='$NomSoc' and etat_paiement=0 and etat_commande=1";
//echo $ic;
