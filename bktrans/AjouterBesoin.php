...
require 'includes/recBesoin.php';
if($etat){
?>
...
$d=mysql_query("select * from files f,categorie c where c.Nom=f.Catagorie and c.appliquer_sur like'100' and  f.etat_dossier='ouvert'  ");
...
$etat_up=mysql_query("insert into purchase values('$Ref','$fournisseur','$doss','$desc','$D','$DP','0','$MN',0,'$Change',0,'$login','$monnaie','','0','$reference','$PR[0]',NULL,NULL,0)");
for($i=1;$i<=$Max;$i++){
...
$TVAA=explode('/',$TVA);
$etat_up=mysql_query("insert into element_purchase values ('$i','$Ref','$desc',$qt,'$prix','$monnaie','$devis','$TVAA[1]','$compte','$TVAA[0]',0);") ;
...
$succes="error";
if($etat_up){    
$succes=$prti.' : '.$Ref.'   '.$N107; 
$user=$_SESSION['login'];
$date_time=date("Y-m-d H:i:s");
$c=mysql_query("INSERT INTO  `historic` ( `Email` ,`Message` ,`Date` ,`id`)VALUES ('$user',  '$succes',  '$date_time', NULL)");

}
$link="MenuUtilisation.php?valeur=AllBesoins.php&titre=$tt&etat_up=$etat_up&url=$url&msg=$succes";
}
?>
<script type="text/javascript"> 
