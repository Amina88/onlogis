...
<link rel="shortcut icon" href="favicon.ico"/>
			...
			<!-- BEGIN PAGE CONTENT-->
				<!-- BEGIN ROW -->
							<!-- BEGIN CHART PORTLET-->
							<?php  
							if(!isset($_GET['gross3'])){  ?>
			
						<div class="portlet light">
								<div class="portlet-title">
									<div class="caption">
										<i class="icon-bar-chart font-green-haze"></i>
										<span class="caption-subject bold uppercase font-green-haze"> <?php if(isset($_GET['det']))echo  $_GET['det']; ?></span>
										<span class="caption-helper"><?php if(isset($_GET['anne'])) echo $_GET['anne']; ?></span>
									</div>
									<div class="tools">
						...
						<div class="col-md-12">
							...
							<div class="portlet light">
								<div class="portlet-title">
									<div class="caption">
										<i class="icon-bar-chart font-green-haze"></i>
										<span class="caption-subject bold uppercase font-green-haze"> <?php if(isset($_GET['rap'])) echo $_GET['rap']; ?></span>
										<span class="caption-helper"><?php if(isset($_GET['ann'])) echo $_GET['ann']; ?></span>
									</div>
									<div class="tools">
										<a href="javascript:;" class="collapse">
										</a>
								...
								<div class="portlet-body">
									<div id="chart_2" class="chart" style="height: 500px;width:100%">
									</div>
								</div>
							</div>
							<!-- END CHART PORTLET-->
...
var ChartsAmcharts = function() {
    ...
    var initChartSample1 = function() {
        var chart = AmCharts.makeChart("chart_1", {
            ...
            "dataProvider": [{
                "year": '<?php echo "janvier"; ?>',
                "income": 23.5,
                "expenses": 18.1
            }, {
                "year": '<?php echo "Fevrier"; ?>',
                "income": 26.2,
                "expenses": 22.8
            }, {
                "year": '<?php echo "Mars"; ?>',
  ...
  "pathToImages": "../assets/global/plugins/amcharts/amcharts/images/",
            ...
            "dataProvider": [{
                "date": "Jan",
                "Montant": "<?php if (isset($_GET['com1'])) echo $_GET['com1'];else echo 0;  ?>",
               "latitude": <?php if (isset($_GET['dep1'])) echo $_GET['dep1'];else echo 0;  ?>,
                "duration":  "<?php if (isset($_GET['inv1'])) echo $_GET['inv1'];else echo 0;  ?>",
				 "dr": "<?php if (isset($_GET['sal1'])) echo $_GET['sal1'];else echo 0;  ?>",
				 "dur": "<?php if (isset($_GET['gross1'])) echo $_GET['gross1'];else echo 0;  ?>", 
				 "dur2":"<?php if (isset($_GET['profit1'])) echo $_GET['profit1'];else echo 0;  ?>"
            }, {
                "date": "Fev",
                "Montant": "<?php if (isset($_GET['com2'])) echo $_GET['com2'];else echo 0;  ?>",
                "latitude": <?php if (isset($_GET['dep2'])) echo $_GET['dep2'];else echo 0;  ?>,
				 "dr": "<?php if (isset($_GET['sal2'])) echo $_GET['sal2'];else echo 0;  ?>",
                "duration":  "<?php if (isset($_GET['inv2'])) echo $_GET['inv2'];else echo 0;  ?>",
				"dur": "<?php if (isset($_GET['gross2'])) echo $_GET['gross2'];else echo 0;  ?>", 
				 "dur2": "<?php if (isset($_GET['profit2'])) echo $_GET['profit2'];else echo 0;  ?>"
				
            }, {
                "date": "Mars",
                "Montant": "<?php if (isset($_GET['com3'])) echo $_GET['com3'];else echo 0;  ?>",
                 "latitude": <?php if (isset($_GET['dep3'])) echo $_GET['dep3'];else echo 0;  ?>,
				  "dr": "<?php if (isset($_GET['sal3'])) echo $_GET['sal3'];else echo 0;  ?>",
                "duration":  "<?php if (isset($_GET['inv3'])) echo $_GET['inv3'];else echo 0;  ?>",
				"dur": <?php if (isset($_GET['gross3'])) echo $_GET['gross3'];else echo 0;  ?>, 
				 "dur2": "<?php if (isset($_GET['profit3'])) echo $_GET['profit3'];else echo 0;  ?>"
            }, {
                "date": "Avrl",
                "Montant": "<?php if (isset($_GET['com4'])) echo $_GET['com4'];else echo 0;  ?>",
                "latitude": <?php if (isset($_GET['dep4'])) echo $_GET['dep4'];else echo 0;  ?>,
				 "dr": "<?php if (isset($_GET['sal4'])) echo $_GET['sal4'];else echo 0;  ?>",
                "duration":  "<?php if (isset($_GET['inv4'])) echo $_GET['inv4'];else echo 0;  ?>",
				"dur": <?php if (isset($_GET['gross4'])) echo $_GET['gross4'];else echo 0;  ?>, 
				 "dur2": "<?php if (isset($_GET['profit4'])) echo $_GET['profit4'];else echo 0;  ?>"
            }, {
                "date": "Mai",
                "Montant": "<?php if (isset($_GET['com5'])) echo $_GET['com5'];else echo 0;  ?>",
                "latitude": <?php if (isset($_GET['dep5'])) echo $_GET['dep5'];else echo 0;  ?>,
				 "dr": "<?php if (isset($_GET['sal5'])) echo $_GET['sal5'];else echo 0;  ?>",
                "duration":  "<?php if (isset($_GET['inv5'])) echo $_GET['inv5'];else echo 0;  ?>",
				"dur": <?php if (isset($_GET['gross5'])) echo $_GET['gross5'];else echo 0;  ?>, 
				 "dur2": "<?php if (isset($_GET['profit5'])) echo $_GET['profit5'];else echo 0;  ?>"
            }, {
                "date": "Juin",
                "Montant": "<?php if (isset($_GET['com6'])) echo $_GET['com6'];else echo 0;  ?>",
                "latitude": <?php if (isset($_GET['dep6'])) echo $_GET['dep6'];else echo 0;  ?>,
				 "dr": "<?php if (isset($_GET['sal6'])) echo $_GET['sal6'];else echo 0;  ?>",
                "duration":  "<?php if (isset($_GET['inv6'])) echo $_GET['inv6'];else echo 0;  ?>",
				"dur": <?php if (isset($_GET['gross6'])) echo $_GET['gross6'];else echo 0;  ?>, 
				 "dur2": "<?php if (isset($_GET['profit6'])) echo $_GET['profit6'];else echo 0;  ?>"
            }, {
                "date": "Juil",
                "Montant": "<?php if (isset($_GET['com7'])) echo $_GET['com7'];else echo 0;  ?>",
                "latitude": <?php if (isset($_GET['dep7'])) echo $_GET['dep7'];else echo 0;  ?>,
				 "dr": "<?php if (isset($_GET['sal7'])) echo $_GET['sal7'];else echo 0;  ?>",
                "duration":  "<?php if (isset($_GET['inv7'])) echo $_GET['inv7'];else echo 0;  ?>",
				"dur": <?php if (isset($_GET['gross7'])) echo $_GET['gross7'];else echo 0;  ?>, 
				 "dur2": "<?php if (isset($_GET['profit7'])) echo $_GET['profit7'];else echo 0;  ?>"
            }, {
                "date": "Aout",
                "Montant": "<?php if (isset($_GET['com8'])) echo $_GET['com8'];else echo 0;  ?>",
               "latitude": <?php if (isset($_GET['dep8'])) echo $_GET['dep8'];else echo 0;  ?>,
			    "dr": "<?php if (isset($_GET['sal8'])) echo $_GET['sal8'];else echo 0;  ?>",
                "duration":  "<?php if (isset($_GET['inv8'])) echo $_GET['inv8'];else echo 0;  ?>",
				"dur": <?php if (isset($_GET['gross8'])) echo $_GET['gross8'];else echo 0;  ?>, 
				 "dur2": "<?php if (isset($_GET['profit8'])) echo $_GET['profit8'];else echo 0;  ?>"
            }, {
                "date": "Sep",
                "Montant": "<?php if (isset($_GET['com9'])) echo $_GET['com9'];else echo 0;  ?>",
				 "dr": "<?php if (isset($_GET['sal9'])) echo $_GET['sal9'];else echo 0;  ?>",
                "latitude": <?php if (isset($_GET['dep9'])) echo $_GET['dep9'];else echo 0;  ?>,
                "duration":  "<?php if (isset($_GET['inv9'])) echo $_GET['inv9'];else echo 0;  ?>",
				"dur": <?php if (isset($_GET['gross9'])) echo $_GET['gross9'];else echo 0;  ?>, 
				 "dur2": "<?php if (isset($_GET['profit9'])) echo $_GET['profit9'];else echo 0;  ?>"
            }, {
                "date": "Oct",
                "Montant": "<?php if (isset($_GET['com10'])) echo $_GET['com10'];else echo 0;  ?>",
                "latitude": <?php if (isset($_GET['dep10'])) echo $_GET['dep10'];else echo 0;  ?>,
				 "dr": "<?php if (isset($_GET['sal10'])) echo $_GET['sal10'];else echo 0;  ?>",
                "duration":  "<?php if (isset($_GET['inv10'])) echo $_GET['inv10'];else echo 0;  ?>",
				"dur": <?php if (isset($_GET['gross10'])) echo $_GET['gross10'];else echo 0;  ?>, 
				 "dur2": "<?php if (isset($_GET['profit10'])) echo $_GET['profit10'];else echo 0;  ?>"
            }, {
                "date": "Nouv",
                "Montant": "<?php if (isset($_GET['com11'])) echo $_GET['com11'];else echo 0;  ?>",
                "latitude": <?php if (isset($_GET['dep11'])) echo $_GET['dep11'];else echo 0;  ?>,
				 "dr": "<?php if (isset($_GET['sal11'])) echo $_GET['sal11'];else echo 0;  ?>",
                "duration":  "<?php if (isset($_GET['inv11'])) echo $_GET['inv11'];else echo 0;  ?>",
				"dur": <?php if (isset($_GET['gross11'])) echo $_GET['gross11'];else echo 0;  ?>, 
				 "dur2": "<?php if (isset($_GET['profit11'])) echo $_GET['profit12'];else echo 0;  ?>"
            }, {
                "date": "Dec",
                "Montant": "<?php if (isset($_GET['com12'])) echo $_GET['com12'];else echo 0;  ?>",
                "latitude": <?php if (isset($_GET['dep12'])) echo $_GET['dep12'];else echo 0;  ?>,
				 "dr": "<?php if (isset($_GET['sal12'])) echo $_GET['sal12'];else echo 0;  ?>",
                "duration":  "<?php if (isset($_GET['inv12'])) echo $_GET['inv12'];else echo 0;  ?>",
				"dur": <?php if (isset($_GET['gross12'])) echo $_GET['gross12'];else echo 0; ?>, 
				 "dur2": "<?php if (isset($_GET['profit12'])) echo $_GET['profit12'];else echo 0;  ?>"
            }],
            "valueAxes": [{
                "id": "MontantAxis",
    ...
    var initChartSample3 = function() {
        var chart = AmCharts.makeChart("chart_3", {
            ...
            "dataProvider": [{
                ...
                "date": "Fev",
                "duration": '<?php if(isset($_GET['inv2'])) echo ($_GET['inv2']);  ?>'
            }, {
                "date": "Mar",
                "duration": '<?php if(isset($_GET['inv3'])) echo ($_GET['inv3']);  ?>'
            }, {
                "date": "Avr",
                "duration": '<?php  if(isset($_GET['inv4'])) echo ($_GET['inv4']);  ?>'
            }, {
                "date": "Mai",
                "duration": '<?php if(isset($_GET['inv5'])) echo ($_GET['inv5']);  ?>'
            }, {
                "date": "Juin",
                "duration": '<?php if(isset($_GET['inv6'])) echo ($_GET['inv6']);  ?>'
            }, {
                "date": "Juill",
                "duration": '<?php if(isset($_GET['inv7'])) echo ($_GET['inv7']);  ?>'
            }, {
                "date": "Aout",
                "duration": '<?php if(isset($_GET['inv8'])) echo ($_GET['inv8']);  ?>',
                 }, {
                "date": "Sep",
                "duration": '<?php if(isset($_GET['inv9'])) echo ($_GET['inv9']);  ?>'
            }, {
                "date": "Nov",
                "duration": '<?php if(isset($_GET['inv10'])) echo ($_GET['inv10']);  ?>'
            }, {
                "date": "Oct",
                "duration": '<?php if(isset($_GET['inv11'])) echo ($_GET['inv11']);  ?>'
            }, {
                "date": "Dec",
                "duration": '<?php if(isset($_GET['inv12'])) echo ($_GET['inv12']);  ?>'
            }],
            "graphs": [{
                "bullet": "square",
                "bulletBorderAlpha": 1,
