...
require'includes/recFacturePeriodique.php';
     if($etat){
...
if(isset($_POST['ajouterFacturePeriodique'])){
$client=$_POST['client'];
$doss=$_POST['Projet'];
$D=$_POST['Date'];
$DP=$_POST['Datep'];
...
if($dtd[0]>$dtf[0]){
$tst=0;
$link="MenuUtilisation.php?valeur=AjouterFacture.php&titre=$N34&etat_up=0&msg=$N33&url=$url2.$N34";
}elseif($dtd[0]==$dtf[0]){
if($dtd[1]>$dtf[1]){
$tst=0;
$link="MenuUtilisation.php?valeur=AjouterFacture.php&titre=$N34&etat_up=0&msg=$N33&url=$url2.$N34";
...
if($dtd[0]<$PD[0]){
$tst=0;
$link="MenuUtilisation.php?valeur=AjouterFacture.php&titre=$N34&etat_up=0&msg=$N35&url=$url2.$N34";
}elseif($dtd[0]==$PD[0]){
if($dtd[1]<$PD[1]){
$tst=0;
...
if($dtd[0]>$PF[0]){
$tst=0;
$link="MenuUtilisation.php?valeur=AjouterFacture.php&titre=$N34&etat_up=0&msg=$N36&url=$url2.$N34";
}elseif($dtd[0]==$PF[0]){
if($dtd[1]>$PF[1]){
$tst=0;
...
if($tst==1){
$idreg=1;
$a=mysql_query("select id_regroup from invoice ORDER BY id_regroup DESC LIMIT 0 , 1");
$t=mysql_fetch_array($a);
if(isset($t[0])){
$idreg=$t[0]+1;
}
$etat_up=mysql_query("insert into invoice values ('$Resum','$payement','$Remercie','$Ref','$doss','$client','$D','$DP','','$MN','$Refer','0','$autre_monnaie','$d_monnaie','0','0','$monnaie','$DFT','0','$OP','$freq','$occu','0','$idreg','$PR[0]',$ETAT)") or die(mysql_error());;
//echo "insert into invoice values ('$Resum','$payement','$Remercie','$Ref','$doss','$client','$D','$DP','','$MN','$Refer','0','$autre_monnaie','$d_monnaie','0','0','$monnaie','$DFT','0','$OP','$freq','$occu','1','$idreg','$PR[0]')";
for($i=1;$i<=$Max;$i++){
...
$link="MenuUtilisation.php?valeur=AllFacture.php&titre=$N37&etat_up=$etat_up&url=$url&msg=$succes";
}
...
require'views/viewFacturePeriodique.php';
?>
