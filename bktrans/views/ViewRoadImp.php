...
<div class="portlet-body">
								<div class="tabbable">
									...
									<form action="MenuUtilisation.php"  method="GET" id="form_sample_2"  class="form-horizontal">
							           <input type="hidden" name="type" value="Road Import">
									<input type="hidden" name="valeur" value="GestionOperationImport.php">
...
<tr>
<td>
<div class="col-md-14"><select class="form-control select2me" name="Objet0"   id="Objet0"  onchange="loadinf(0);"><option value=""><?php echo $N13; ?></option><option value="piece"><?php echo $N15; ?></option><option value="Conteneur 20 Dry">Conteneur 20 Dry</option><option value="Conteneur 40 Dry">Conteneur 40 Dry</option><option value="Conteneur 45 High Cube Dry">Conteneur 45 High Cube Dry </option><option value="Conteneur 20 Reefer">Conteneur 20 Reefer</option><option value="Conteneur 40 Reefer">Conteneur 40 Reefer </option><option value="Conteneur 20 Open Top">Conteneur 20 Open Top </option><option value="Conteneur 40 Open Top">Conteneur 40 Open Top </option></select></div>
				...
				<!------ Contenue -->					
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3"><?php echo $N30; ?> 
										 ...
										 <div class="col-md-4">
										 <select class="form-control select2me" ID="Exo" name="Exo"  >
										<option value="oui"><?php echo $N39; ?></option>
										<option value="non"><?php echo $N38; ?></option>
										</select>
										</div>
									</div>
                                    <div class="form-group">
										<label class="control-label col-md-3"><?php echo $N32; ?> 
										</label>
										 <div class="col-md-4">
										 <select class="form-control select2me" id="enlev" name="Enlevement"  >
										<option value="oui"><?php echo $N39; ?></option>
										<option value="non"><?php echo $N38; ?></option>
										</select>
										</div>
                                    ...
                                    <div class="form-group">
										<label class="control-label col-md-3"><?php echo $N33; ?>
										 ...
										 <div class="col-md-4">
										 <select class="form-control select2me" name="type_exo"  >
										<option value="Consomable"><?php echo $N36; ?></option>
										<option value="Admission temporaire"><?php echo $N37; ?></option>
										</select>
										</div>
									</div>
									  <div class="form-group">
										<label class="control-label col-md-3"><?php echo $N34; ?>
										</label>
										 <div class="col-md-4">
										 <select class="form-control select2me" name="type_dec"  >
...
<option value="IM9">IM9</option>
<option value="IM10">IM10</option>
<option value="IM11">IM11</option>
<option value="IM12">IM12</option></select>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-7">
											<div class="input-icon right">
												<i class="fa"></i>
												<input type="checkbox" class="form-control" name="app" value="oui" checked />
											</div>
										</div>
							</div>
<!--  fin contenuie			-->						
