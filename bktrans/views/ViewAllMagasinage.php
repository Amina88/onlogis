				...
				<?php
				$s=mysql_query("select * from magasinage   ");
				?>
...
?>
				...
				<tr  > 
    				<td><font size="1"><a href="MenuUtilisation.php?valeur=UpdateMagasinage.php&NomMat=<?php echo $admin[0];?>&titre=<?php echo $admin[0]." ".$N24; ?>&url=<?php echo $url2.$N26;?>&mdm=1" title="<?php echo $N26; ?>"><?php echo $admin[0];?></a></td> 
					...
					<td><a href="MenuUtilisation.php?valeur=UpdateMagasinage.php&NomMat=<?php echo $admin[0];?>&titre=<?php echo $N23." ".$admin[0]; ?>&url=<?php echo $url2.$N15;?>" title="<?php echo $N15; ?>"><i class="fa fa-pencil-square-o"></i></a>
					<a href="MenuUtilisation.php?valeur=deleteMagasinage.php&NomMat=<?php echo $admin[0];?>&url=<?php echo $url;?>&titre=<?php echo $_GET['titre'];?>" onclick="return confirmLink(this) ;"  title="<?php echo $N13; ?>"><i class="fa fa-trash-o"></i></a></td> 
				</tr> 
...
?>         </tbody>
			 ...
			 <a href="MenuUtilisation.php?valeur=AjouterAuMagasin.php&titre=<?php echo $N20; ?>&url=<?php echo $url.'.'.$N20; ?>" >
