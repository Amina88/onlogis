...
<div class="col-md-3">
<input type="Number" min="0" id="prix1"  style="width:85px;" name="prix1" <?php if("$permission[1]"!="Administrateur" && "$permission[39]"!='39'){ echo "readonly";} ?>  onMouseOut="valider();" placeholder="0.00" required="required" class="form-control" >
</div></td>
</div></td>
<td>
<div class="form-group">	
