...
?>
<tr  style="background:#e4e8e8;height:6px;"  > 
    				<td colspan="3"><font size="1"><b><?php  echo $N12; ?>:<?php  echo $admin[3]; ?> </td> 
    				<td colspan="3"><font size="1"><b><?php  echo $N13; ?><?php  echo $admin[0]; ?> </td> 
...
?>
						  ...
						  <div class="portlet box yellow">
                           <div class="portlet-title">
							...
							<form action="Rapport_Journal.php" id="form_sample_2" class="form-horizontal" method="post" target=_blank>
								<div class="form-body">
