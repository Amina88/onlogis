<form method="POST" action="MenuUtilisation.php?valeur=AjouterFactureperiodique.php" id="form_sample_2" class="form-horizontal" >
...
<div class="col-md-4">
<div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control"  name="Datep"  style="width:120px" required value="" id="datep" >
												<span class="input-group-btn">
												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div>
...
<tr>
<td>
<div class="form-group"><label class="control-label col-md-2"><?php echo $N30; ?><span class="required">* </span></label>
<br><br>
<div class="col-md-4">
<input type="Number" name="freq"  class="form-control "  required="required" style="width:120px;">
</div>
</div>

</td>
<td>
<div class="form-group"><label class="control-label col-md-2"><?php echo $N31; ?><span class="required">* </span></label>
<br><br>
<div class="col-md-4">
<input type="Number" name="ocuu" class="form-control "   required="required" style="width:100px;">
...
<input type="hidden" name="ajouterFacturePeriodique" value="ajouterFacturePeriodique"> 
	...
	<div class="form-actions">
									 ...
									 <div class="row">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn green"  value="1" name="SauvgarderFactureP" ><?php echo $N29; ?></button>
											<button type="submit" class="btn tt" value="0" name="SauvgarderFactureP" ><?php echo $N26; ?></button>
