...
function FancyTableResum($header, $data)
{
	...
	if($row[0]!='Fin'){
        ...
        $this->Cell(160,8,$row[1],'L',0,'L',$fill);
        $this->Cell(35,8,$row[4],'R',0,'R',$fill);
        $this->Cell(45,8,$row[5],'R',0,'R',$fill);
...
$this->SetFont('Arial','',8);
  ...
  $this->Cell(285,8,"VIDE !!!!",'C',0,'C',$fill);
