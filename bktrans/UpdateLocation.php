...
if($dtd[0]>$dtf[0]){
$test=0;
$link="MenuUtilisation.php?valeur=UpdateLocation.php&NomMat=$id&titre=$N1&etat_up=0&msg=$N14";
}elseif($dtd[0]==$dtf[0]){
if($dtd[1]>$dtf[1]){
$test=0;
$link="MenuUtilisation.php?valeur=UpdateLocation.php&NomMat=$id&titre=$N1&etat_up=0&msg=$N14";
...
if($KF < $KD){
$test=0;
$link="MenuUtilisation.php?valeur=UpdateLocation.php&NomMat=$id&titre=$N1&msg=$N13&etat_up=0";

}
$testres=1;
if($ETAT==1){
$LCT=mysql_query("select * from  location where Reference='$id'");	
$LC=mysql_fetch_array($LCT);
$EQP=mysql_query("select Equipment from  location where Equipment='$EQ' AND Etat=1 AND  Reference!='$id' ");	
$EQPT=mysql_fetch_array($EQP);
if($EQPT[0]!=""){
$testres=0;
}
if($LC[7]==0 && $testres==1 ){
$etat_up=mysql_query("update  equipment set  Etat='0' where  Num='$LC[8]'");
...
$EQP=mysql_query("select * from  equipment where Num='$EQ'");	
$EQPT=mysql_fetch_array($EQP);
$LCT=mysql_query("select Equipment from  location where Reference='$id'");	
$LC=mysql_fetch_array($LCT);
if($EQPT[2]==0 && $EQ!=$LC[0]){
$test=0;
$link="MenuUtilisation.php?valeur=UpdateLocation.php&NomMat=$id&titre=$N1&msg=$N17&etat_up=0";
}else{
$etat_up=mysql_query("update  equipment set  Etat='1' where  Num='$EQ'");
...
$etat_up=mysql_query("update  location set  Client='$CL',Dossier='$DS',Date_debut='$D',Date_fin='$DP',Kilometrage_debut='$KD',Kilometrage_fin='$KF',Etat='$ETAT',Equipment='$EQ',Description='$Desc',facturation='$FCT' where Reference='$id'");
...
$c=mysql_query("INSERT INTO  `historic` ( `Email` ,`Message` ,`Date` ,`id`)VALUES ('$user',  '$succes',  '$date_time', NULL)");
	...
	$etat_up=mysql_query("update  location set  Client='$CL',Dossier='$DS',Date_debut='$D',Date_fin='$DP',Kilometrage_debut='$KD',Kilometrage_fin='$KF',Description='$Desc',facturation='$FCT' where Reference='$id'");
if($etat_up){
$succes=$N79.' : '.$id.'  '.$N108;
$user=$_SESSION['login'];
$date_time=date("Y-m-d H:i:s");
$c=mysql_query("INSERT INTO  `historic` ( `Email` ,`Message` ,`Date` ,`id`)VALUES ('$user',  '$succes',  '$date_time', NULL)")or die(mysql_error());
...
<script type="text/javascript"> 
 document.location.href="<?php echo $link ; ?>";
  ...
  <?php
	...
	$files=mysql_query("select * from  categorie where appliquer_sur in( '010','111','110',010,011)");	
	$NomMat=$_GET['NomMat'];

	$_SESSION['NomMat']=$NomMat;
	$LCT=mysql_query("select * from  location where Reference='$NomMat'");	
...
<div class="portlet box yellow">
					...
					<div class="portlet-body form">
						<form action="MenuUtilisation.php?valeur=UpdateLocation.php" id="form_sample_2" class="form-horizontal" method="POST">
						<div class="form-body">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-4">
                                            ...
                                            <option value="<?php echo $LC[8]; ?>"><?php echo $LC[8]; ?></option>										
											</select>
										</div>
									</div>
									<div class="form-group">
							...
							<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input   class="form-control"type="number"  name="KD" value="<?php echo $LC[5]; ?>" required="required"/>
											</div>
										</div>
									</div>
									 <div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-icon right">
												<i class="fa"></i>
												<input   class="form-control"type="number"  name="KF" value="<?php echo $LC[6]; ?>" required="required"/>
											</div>
										</div>
									</div>
									<div class="form-group">
					                  <label class="col-md-3 control-label"><?php echo $N10; ?></label>
										<div class="col-md-6">
											...
											<input type="radio" name="ETAT" id="optionsRadios25" value="1" <?php if($LC[7]==1){ echo "checked";} ?>>
											</div> <?php echo $N15; ?> </label>
												<label class="radio-inline">
												<div class="radio" id="uniform-optionsRadios26"><input type="radio" name="ETAT" id="optionsRadios26" value="0"  <?php if($LC[7]==0){ echo "checked";} ?>></div><?php echo $N16; ?> </label>
										...
										<div class="form-group">
													...
													<div class="col-md-4">
														<textarea class="form-control" rows="3" name="description" required><?php echo $LC[9]; ?></textarea>
													</div>
									 </div>
									 <div class="form-group">
                                      ...
                                      <option value="oui" <?php if($LC['facturation']=="oui"){echo "selected";} ?> ><?php echo $N21; ?></option>
