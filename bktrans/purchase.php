...
$this->MultiCell($w = 50,5*$nln,utf8_decode($data['desig']),1,'LT',6);
...
$this->MultiCell($w = 29,5*$nln,number_format($data['pu'],2,',','.')." ".$data['monnaie'],1,'C',1);

$push_right += $w;
$this->SetXY($x + $push_right, $y);

$this->MultiCell($w = 29,5*$nln,number_format($data['net'],2,',','.')." ".$data['monnaie'],1,'C',1);

$push_right += $w;
$this->SetXY($x + $push_right, $y);

$this->MultiCell($w = 29,5*$nln,"($MN1[0]%)  ".number_format($data['tva'],2,',','.')." ".$data['monnaie'],1,'C',1);

$push_right += $w;
$this->SetXY($x + $push_right, $y);

$this->MultiCell(30,5*$nln,number_format($data['tt'],2,',','.')." ".$data['monnaie'],1,'C',1);
