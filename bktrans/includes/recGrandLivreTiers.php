...
$date1=date('Y-m-01');
$date2=date('Y-m-31');
$comm1=mysql_query("select DISTINCT `Partenaire`  from journal order by id desc")or die(mysql_error());
$comm2=mysql_query("select DISTINCT `Partenaire`  from journal order by id desc");
