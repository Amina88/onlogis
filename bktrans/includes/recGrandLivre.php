...
$date1=date('Y-m-01');
$date2=date('Y-m-31');
$comm1=mysql_query("select DISTINCT `Numero_Compte` ,`Compte` from detaile_journal order by id_journal desc");
$comm2=mysql_query("select DISTINCT `Numero_Compte` ,`Compte` from detaile_journal order by id_journal desc");
