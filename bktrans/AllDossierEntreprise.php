...
require'includes/recAllDossierEntreprise.php';
if($etat)
{
?>
...
$req = mysql_query("select * from files f,categorie c where c.Nom=f.Catagorie and c.appliquer_sur like'1%'  ");
...
<?php if($permiss_stat==1){ ?>					
				...
				<td><a href="MenuUtilisation.php?valeur=EditDossier.php&Reference=<?php echo $admin[0];?>&titre=<?php echo $N15; ?> <?php echo $admin[0];?>&url=<?php echo $url.'.'.$N19;?>&Depense=true" title="<?php echo $N19; ?>" ><i class="fa fa-pencil-square-o"></i></a>
					<?php if($dosss==NULL){ echo $dosss; ?><a href="MenuUtilisation.php?valeur=gestionDossier.php&NomSoc=<?php echo $admin[0];?>&type=delete&Depense=true" onclick="return confirmLink(this) ;"  title="<?php echo $N17; ?>" >
					<i class="fa fa-trash-o"></i></a>
					<?php }else{ ?> 
					<a href=""  title="<?php echo $N16; ?>" >
					<i class="fa fa-trash-o"></i></a>
					<?php } ?> &nbsp;
					<a href="MenuUtilisation.php?valeur=operation_groupe_dossier.php&type=Fermer&Ref=<?php echo $admin[0]; ?>&etat=<?php echo $etat; ?>&Depense=true" onclick="return confirm('<?php echo $TTLE; ?>') ;" ><?php echo $st; ?></a></td> 
				</tr> 
