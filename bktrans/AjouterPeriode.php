...
if($dtd[0]>$dtf[0]){
$tst=0;
$link="MenuUtilisation.php?valeur=Financ_periode.php&titre=$TT&etat_up=0&msg=$N11&SauvgarderPRD=tt&url=$url2";
}elseif($dtd[0]==$dtf[0]){
if($dtd[1]>$dtf[1]){
$tst=0;
$link="MenuUtilisation.php?valeur=Financ_periode.php&titre=$TT&etat_up=0&msg=$N11&SauvgarderPRD=tt&url=$url2";
                                 ...
                                 <div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control"  name="dateD"  value="" required>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<div class="input-group date date-picker" data-date-format="yyyy-mm-dd">
												<input type="text" class="form-control"  name="dateF" value="" required>
												<span class="input-group-btn">
												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div>
