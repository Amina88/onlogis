...
$nln=0;
$push_right = 0;
$nln1=$this->NbLines(60,$data['desig']);
...
$this->MultiCell($w = 10,6,$i,1,'LT',1);

$push_right += $w;
$this->SetXY($x + $push_right, $y);

$this->MultiCell($w =30,6,$data['desig'],1,'C',1);

$push_right += $w;
$this->SetXY($x + $push_right, $y);

$this->MultiCell($w = 35,6,$data['pu'],1,'C',1);

$push_right += $w;
$this->SetXY($x + $push_right, $y);

$this->MultiCell($w = 35,6,$data['tt']." KG",1,'C',1);

$push_right += $w;
$this->SetXY($x + $push_right, $y);
$this->MultiCell($w = 35,6,$data['qte']." CM",1,'C',1);

$push_right += $w;
$this->SetXY($x + $push_right, $y);

$this->MultiCell($w = 40,6,$data['tva'],1,'C',1);
